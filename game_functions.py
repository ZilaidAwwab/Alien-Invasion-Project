...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    ...
    # Redrew the screen during each pass through the loop
...
def check_bullet_alien_collision(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # IF we want a bullet to reach the top and destroy every alien of its way
    # collisions = pygame.sprite.groupcollide(bullet, aliens, False, True)
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # Spaces between each alien is equal to one alien width
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Check if the fleet is at the edge, then Update the position of the aliens in the fleet"""
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            # Treat this as same as ship got hit
            ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets)
            break
